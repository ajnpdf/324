...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      /* AJN_R14_5_DIRECT_LEGACY_REDIRECTS_START */
      ...
      { source: '/tools/pdf-excel', destination: '/pdf-to-excel', permanent: true },
      { source: '/tools/ppt-pdf', destination: '/ppt-to-pdf', permanent: true },
      { source: '/tools/jpg-pdf', destination: '/jpg-to-pdf', permanent: true },
      ...
      { source: '/tools/smart-read', destination: '/pdf-text', permanent: true },
      { source: '/tools/pdf-ppt', destination: '/pdf-to-powerpoint', permanent: true },
      { source: '/tools/ocr-searchable', destination: '/scanned-pdf-to-searchable-pdf', permanent: true },
      /* AJN_R14_5_DIRECT_LEGACY_REDIRECTS_END */{ source: '/:path*', has: [{ type: 'host', value: 'ajnpdf.com' }], destination: 'https://www.ajnpdf.com/:path*', permanent: true },
      ...
      { source: '/tools/pdf-ppt', destination: '/pdf-to-powerpoint', permanent: true },
      { source: '/tools/ocr-searchable', destination: '/scanned-pdf-to-searchable-pdf', permanent: true },
      { source: '/word-pdf', destination: '/word-to-pdf', permanent: true },
      { source: '/pdf-word', destination: '/pdf-to-word', permanent: true },
      { source: '/excel-pdf', destination: '/excel-to-pdf', permanent: true },
      { source: '/pdf-excel', destination: '/pdf-to-excel', permanent: true },
      { source: '/ppt-pdf', destination: '/ppt-to-pdf', permanent: true },
      ...
      { source: '/smart-read', destination: '/pdf-text', permanent: true },
      { source: '/pdf-ppt', destination: '/pdf-to-powerpoint', permanent: true },
      { source: '/ocr-searchable', destination: '/scanned-pdf-to-searchable-pdf', permanent: true },
