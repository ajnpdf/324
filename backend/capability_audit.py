...
def main() -> None:
    ...
    required_ids = {
        ...
        "scanned-pdf-to-text", "scanned-pdf-to-searchable-pdf", "image-to-searchable-pdf", "image-to-text",
        "jpg-to-pdf", "pdf-to-jpg", "pdf-to-docx", "docx-to-pdf",
        "pdf-to-xlsx", "xlsx-to-pdf", "pdf-to-pptx", "pptx-to-pdf",
