...
def main() -> None:
    ...
    parser.add_argument("--scopes", default="read,convert,ocr", help="Comma-separated scopes: read,convert,ocr,sign")
    ...
    record = {
        "id": args.id.strip() or "developer",
        "secret_sha256": hash_api_key(secret),
        "scopes": scopes,
        "rate_per_minute": max(1, min(600, args.rate)),
    }
