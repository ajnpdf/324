...
def main() -> None:
    with tempfile.TemporaryDirectory(prefix="ajn-image-pdf-quality-") as temporary:
        ...
        images_to_pdf(
            [transparent, photo],
            output,
            {"page_size": "auto", "orientation": "auto", "margin_mm": 0, "dpi": 150, "quality": 94},
        )
        ...
        with fitz.open(output) as pdf:
            ...
            # Transparent source background must composite on the white PDF page,
            # not become an opaque black JPEG background.
