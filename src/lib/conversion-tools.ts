...
export const CONVERSION_TOOLS: ServiceTool[] = [
  ...
  tool('heic-to-pdf', 'HEIC to PDF', 'Convert HEIC and HEIF photos into PDF pages.', FileImage, 'img', ['heic to pdf', 'iphone photo pdf'], 'HEIC support depends on the server HEIF codec.'),
  ...
  tool('pdf-to-mobi', 'PDF to MOBI', 'Create a MOBI eBook from extracted PDF text.', BookOpen, 'pdf', ['pdf to mobi', 'kindle mobi pdf'], 'Requires Calibre on the processing server.'),
  tool('pdf-to-azw3', 'PDF to AZW3', 'Create an AZW3 Kindle eBook from extracted PDF text.', BookOpen, 'pdf', ['pdf to azw3', 'kindle pdf conversion'], 'Requires Calibre on the processing server.'),
  ...
  tool('doc-to-pdf', 'DOC to PDF', 'Convert legacy DOC documents into PDF.', FileText, 'pdf', ['doc to pdf', 'old word pdf'], 'Requires LibreOffice on the processing server.'),
  ...
  tool('odt-to-pdf', 'ODT to PDF', 'Convert OpenDocument text files into PDF.', FileText, 'pdf', ['odt to pdf', 'open document pdf'], 'Requires LibreOffice on the processing server.'),
  tool('ods-to-pdf', 'ODS to PDF', 'Convert OpenDocument spreadsheets into PDF.', FileSpreadsheet, 'pdf', ['ods to pdf', 'open document spreadsheet pdf'], 'Requires LibreOffice on the processing server; print areas and charts may render differently.'),
  tool('odp-to-pdf', 'ODP to PDF', 'Convert OpenDocument presentations into PDF.', Presentation, 'pdf', ['odp to pdf', 'open document presentation pdf'], 'Requires LibreOffice on the processing server; animations and transitions are not included.'),
  ...
  tool('xls-to-pdf', 'XLS to PDF', 'Convert legacy XLS workbooks into PDF.', FileSpreadsheet, 'pdf', ['xls to pdf', 'old excel pdf'], 'Requires LibreOffice on the processing server.'),
  ...
  tool('ppt-to-pdf', 'PPT to PDF', 'Convert legacy PPT presentations into PDF.', Presentation, 'pdf', ['ppt to pdf', 'old powerpoint pdf'], 'Requires LibreOffice on the processing server.'),
  ...
  tool('mobi-to-pdf', 'MOBI to PDF', 'Convert a MOBI eBook into PDF.', BookOpen, 'pdf', ['mobi to pdf', 'kindle pdf'], 'Requires Calibre on the processing server.'),
  tool('azw3-to-pdf', 'AZW3 to PDF', 'Convert an AZW3 Kindle eBook into PDF.', BookOpen, 'pdf', ['azw3 to pdf', 'kindle ebook pdf'], 'Requires Calibre on the processing server.'),
  ...
  tool('xps-to-pdf', 'XPS to PDF', 'Convert an XPS document into PDF.', FileArchive, 'pdf', ['xps to pdf', 'microsoft xps pdf'], 'Requires MuPDF or Ghostscript on the processing server.'),
];
