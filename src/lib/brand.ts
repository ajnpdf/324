export const AJN_BRAND = {
  ...
  developerBio:
    'Anjan Kumar is the developer behind AJN PDF and AJN Studio. He builds practical PDF, OCR, image and document workflows with Next.js, React, TypeScript and a Python FastAPI processing service, with an emphasis on clear interfaces, transparent processing labels and useful results.',
