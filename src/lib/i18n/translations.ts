...
const legacyPhraseToKey: Record<string, string> = {
  ...
  'SERVER MODE': 'landing.serverMode',
  ...
  'Live health reflects only the current secure-processing service check.': 'landing.healthNote',
  'Completed in this browser session': 'landing.completedSession',
  ...
  'Local Buffer Authentication': 'processing.browser',
  ...
  'Safe Local Buffer': 'processing.browser',
  'Safe local buffer active': 'processing.browser',
  'Safe Local session buffer active': 'processing.browser',
  ...
  'Synthesizing Document...': 'processing.creatingPdf',
  'Synthesizing Pixel Map': 'processing.processing',
