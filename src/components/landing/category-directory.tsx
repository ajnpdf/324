...
const intentContent = {
  conversion:{outcomes:['Convert PDFs to editable document formats','Create PDFs from documents and structured data','Run OCR on scans and document photos'],workflows:[{href:'/pdf-to-docx',label:'PDF to Word'},{href:'/docx-to-pdf',label:'Word to PDF'},{href:'/scanned-pdf-to-text',label:'Scanned PDF to Text'},{href:'/pdf-to-xlsx',label:'PDF to Excel'}]},
  image:{outcomes:['Combine images into a PDF','Export PDF pages into image files','Prepare scans, receipts and searchable documents'],workflows:[{href:'/jpg-to-pdf',label:'JPG to PDF'},{href:'/png-to-pdf',label:'PNG to PDF'},{href:'/pdf-to-png',label:'PDF to PNG'},{href:'/image-to-text',label:'Image to Text OCR'}]},
