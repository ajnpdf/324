...
export function FeatureShowcase() {
  return <section className="relative mx-auto max-w-7xl px-4 py-20 md:px-8 md:py-28">
    <div className="grid overflow-hidden rounded-[1.8rem] border border-slate-200 bg-white shadow-[0_28px_80px_rgba(37,62,113,.09)] lg:grid-cols-[1.05fr_.95fr]">
      ...
      <div className="p-6 md:p-10 lg:p-12"><span className="ajn-section-kicker">Focused document workspace</span><h2 className="mt-5 text-4xl font-black tracking-[-.04em] text-slate-950 md:text-5xl">A cleaner path from upload to result.</h2><p className="mt-5 text-base font-medium leading-7 text-slate-600">AJN PDF keeps the important controls close to the file you are working on, then gives you a clear result with download and sharing actions when supported.</p>
        <div className="mt-8 space-y-4">{[
          [Search,'Find tools quickly','Search, filter and choose a comfortable 2-column, compact 4-column or list view.'],
          [FileCheck2,'Review before you finish','Tool pages keep settings, previews and limitations close to the workflow.'],
          [Share2,'Download or share','Completed results offer a clear next step instead of leaving you on a loading screen.'],
