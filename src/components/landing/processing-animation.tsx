...
const PROCESSING_LOGS = ['Analyzing File', 'Parsing Elements', 'Exporting Formats', 'Complete'] as const;
...
export function ProcessingAnimation() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      index = (index + 1) % PROCESSING_LOGS.length;
      setStatus(PROCESSING_LOGS[index]);
    }, 2500);
