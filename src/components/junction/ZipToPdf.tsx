...
export default function ZipToPdf(){
  ...
  const run=async()=>{if(!files.length){setE("Upload a ZIP file.");return;}setE("");setL(true);
  ...
  return(<ToolWorkspace title="ZIP to PDF" description="BULK ARCHIVE INGESTION & ASSEMBLY" icon="📦" accent="#6B7280" badge="ARCHIVE CONVERSION">
