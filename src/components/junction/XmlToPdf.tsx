...
import { FileCode, CheckCircle2, Download, Loader2, RefreshCcw, Zap, Settings2, Edit3, Terminal, Share2} from 'lucide-react';
...
export default function XmlToPdf() {
  ...
  return (
    <ToolWorkspace title="XML/JSON to PDF" description="CREATE A READABLE PDF FROM XML OR JSON DATA" icon="📊" badge="DATA TO PDF" accent="#6B7280">
