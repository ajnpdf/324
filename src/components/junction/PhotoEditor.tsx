...
export default function PhotoEditor() {
  ...
  return (
    <ToolWorkspace title="Photo Editor" description="PROFESSIONAL RETOUCHING & RETOUCHING" icon="🎨" accent={T.pink} badge="STUDIO UNIT">
            ...
            <motion.div key="configure" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex flex-col gap-10">
              <div className="p-6 bg-white/40 rounded-[2.5rem] border border-black/5 flex items-center justify-between shadow-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">{fmtBytes(files[0]?.size || 0)} • Layer Mapping Ready</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                <div className="lg:col-span-7 space-y-4">
                  <Label className="text-[10px] font-black uppercase text-slate-400 tracking-widest ml-1">Studio Viewport</Label>
                ...
                <aside className="lg:col-span-5 space-y-8">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button onClick={run} className="flex-[2] h-16 bg-primary text-white font-black text-xs uppercase tracking-widest rounded-2xl shadow-xl hover:scale-105 transition-all gap-3 border-2 border-white/20 active:scale-95">
                      <Zap className="w-4 h-4" /> Finalize Retouching
                    </Button>
                  </div>
                </aside>
              </div>
          ...
          {phase === 'processing' && (
            <div className="py-32 flex flex-col items-center space-y-8 text-center">
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">Synthesizing Pixel Map</p>
                <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">Hardware-accelerated transcoding...</p>
              </div>
            </div>
          )}
          ...
          {phase === 'done' && result && (
            <motion.div key="done" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="py-12 flex flex-col items-center space-y-10 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm font-bold text-slate-500 uppercase tracking-widest">Image correctly retouched and optimized</p>
              </div>
              ...
              <div className="p-8 bg-white border-2 border-black/5 rounded-[3rem] w-full max-w-sm flex items-center justify-center gap-4 shadow-xl mx-auto">
                ...
                <div className="text-left overflow-hidden">
                  ...
                  <p className="text-sm font-black text-slate-950 truncate">Edited_Asset.jpg</p>
                </div>
              </div>
