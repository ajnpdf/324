...
const pdfCategories = [
  ...
  },
  {
    title: "CONVERT TO",
    tools: [
      { name: "WORD to PDF", href: "/tools/word-pdf", icon: FileText, color: "text-blue-600" },
      { name: "EXCEL to PDF", href: "/tools/excel-pdf", icon: FileSpreadsheet, color: "text-emerald-700" },
      { name: "JPG to PDF", href: "/tools/jpg-pdf", icon: ImageIcon, color: "text-amber-500" },
      { name: "HTML to PDF", href: "/tools/html-pdf", icon: Code2, color: "text-indigo-600" },
    ]
  },
  {
    title: "CONVERT FROM",
    tools: [
      { name: "PDF to WORD", href: "/tools/pdf-word", icon: FileEdit, color: "text-blue-600" },
      { name: "PDF to EXCEL", href: "/tools/pdf-excel", icon: FileSpreadsheet, color: "text-emerald-700" },
      { name: "PDF to PPT", href: "/tools/pdf-ppt", icon: Presentation, color: "text-orange-500" },
      { name: "PDF to JPG", href: "/tools/pdf-jpg", icon: ImageIcon, color: "text-amber-500" },
    ]
  },
  {
    title: "EDIT & SIGN",
  ...
  },
  {
    title: "INTELLIGENCE",
    tools: [
      { name: "Neural OCR", href: "/tools/ocr-advanced", icon: BrainCircuit, color: "text-purple-600" },
      { name: "Repair PDF", href: "/tools/repair-pdf", icon: Wrench, color: "text-red-500" },
      { name: "Make Searchable", href: "/tools/ocr-searchable", icon: Search, color: "text-blue-500" },
    ]
  }
];
