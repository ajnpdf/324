...
export default function AddText() {
  ...
  return (
    <ToolWorkspace title="Add Text" description="PLACE CUSTOM TEXT ON A PDF PAGE" icon="✏️" badge="PDF EDITING" accent="#0369A1">
                ...
                <aside className="lg:col-span-5 space-y-6">
                  <section className="space-y-4">
                    ...
                    <Card className="bg-white/60 backdrop-blur-xl border-black/5 rounded-3xl p-8 space-y-8 shadow-xl">
                      ...
                      <div className="rounded-2xl border border-blue-500/10 bg-blue-500/5 p-4 text-sm text-slate-600 dark:text-slate-300">
