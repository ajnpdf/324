...
const DESC:Record<string,string>={jpeg:"Best for photos. Lossy — smaller files, slight quality loss.",png:"Lossless with transparency. Best for graphics and logos.",webp:"Modern format with excellent compression for photos and graphics.",bmp:"Uncompressed. Very large files but perfect quality."};
export default function ConvertImage(){
  ...
  return(<ToolWorkspace title="Convert Image" description="Convert images between JPEG, PNG, WebP and BMP formats." icon="🔀" accent={T.purple}>
    ...
    :<div style={{display:"flex",flexDirection:"column",gap:16}}>
      ...
      <Info bg="#F5F3FF" col="#5B21B6">ℹ️ {DESC[fmt]}</Info>
