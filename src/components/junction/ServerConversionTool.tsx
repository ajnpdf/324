  ...
  const process=async()=>{
    ...
    try{
      const converted=await convertOnServer({
        ...
        options:{language,dpi,quality,grayscale,pages:pageRange,page_size:pageSize,orientation,margin_mm:marginMm,auto_rotate:true,deskew:true,denoise:true,contrast:1.35},
      });
