    ...
    <ToolWorkspace title="Unlock PDF" description="Remove encryption using the current valid password" accent="#059669">
      {result ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <BackendStatus />
          <Drop files={files} onChange={setFiles} accept=".pdf,application/pdf" label="Select an encrypted PDF" sub={`Encrypted PDF · live server limit ${liveLimits.maxFileSizeMb} MB`} />
