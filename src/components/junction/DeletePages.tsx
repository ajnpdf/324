...
export default function DeletePages() {
  ...
  return (
    <ToolWorkspace title="Delete Pages" description="REMOVE UNWANTED SEGMENTS VISUALLY" icon="🗑️" badge="CLEANUP UNIT" accent="#EF4444">
            ...
            <motion.div key="upload" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95 }} className="w-full">
              ...
              >
                ...
                <div className="text-center space-y-1 px-8 relative z-10">
                  <h3 className="text-2xl font-black tracking-tighter uppercase text-slate-950">Drop PDF to Prune</h3>
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em]">Surgical Local Deletion</p>
                </div>
              </div>
            </motion.div>
          )}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div className="lg:col-span-7 space-y-3">
                  <div className="flex items-center justify-between px-1">
                    <Label className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Select Pages to Delete</Label>
                    ...
                    <ScrollArea className="h-[600px] p-8">
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-6">
                        {pages.map((page) => (
                          ...
                          >
                            <img src={page.preview} className={cn("w-full h-full object-cover transition-all", page.selected && "grayscale opacity-20")} alt="" />
                  ...
                  <div className="p-8 bg-slate-900 text-white rounded-[3rem] shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10 space-y-6">
                      <div className="space-y-2">
                        <h4 className="text-2xl font-black uppercase italic tracking-tighter">Ready to Purge</h4>
                        <p className="text-[10px] font-bold opacity-60 uppercase tracking-widest leading-relaxed">Processing occurs locally. Selected pages will be permanently removed from the output binary.</p>
                      </div>
                      <Button 
                      ...
                      >
                        <Trash2 className="w-4 h-4 mr-2" /> Delete Marked Pages
                      </Button>
                    </div>
                  </div>
