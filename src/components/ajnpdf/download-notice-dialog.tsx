            ...
            <div className="p-10 flex flex-col items-center text-center space-y-8">
              ...
              <div className="flex w-full gap-4 pt-4">
                ...
                <button 
                  ...
                  className="flex-[2] h-14 bg-white text-slate-950 hover:bg-white/90 font-black text-[10px] uppercase tracking-widest rounded-2xl shadow-xl transition-all flex items-center justify-center gap-2"
                >
