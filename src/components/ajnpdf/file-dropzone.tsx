  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="w-20 h-20 rounded-2xl bg-white border border-black/5 flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500"
      >
      ...
      <div className="text-center space-y-2 px-12 relative z-10">
        ...
        <p className="text-sm font-medium text-slate-500 uppercase tracking-widest text-center">
          Your files stay 100% local. Zero server transit.
        </p>
