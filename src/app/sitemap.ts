...
type CorePageDefinition = {
  path: string;
  changeFrequency: SitemapFrequency;
  priority: number;
};

// Keep this list deterministic. Do not fetch live backend/CMS data here.
const CORE_PAGE_DEFINITIONS: CorePageDefinition[] = [
  { path: '/', changeFrequency: 'daily', priority: 1 },
  { path: '/pdf-tools', changeFrequency: 'weekly', priority: 0.9 },
  { path: '/conversion-tools', changeFrequency: 'weekly', priority: 0.9 },
  ...
  { path: '/blog/ocr-digital-archiving', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/blog/reduce-pdf-size-keep-quality', changeFrequency: 'monthly', priority: 0.65 },
  { path: '/blog/pdf-vs-docx', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/blog/how-ocr-works', changeFrequency: 'monthly', priority: 0.65 },
  { path: '/blog/improve-ocr-indian-languages', changeFrequency: 'monthly', priority: 0.65 },
  { path: '/blog/scanned-pdf-to-word', changeFrequency: 'monthly', priority: 0.65 },
  { path: '/blog/why-pdf-compression-limited', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/blog/image-to-pdf-jpg-vs-png', changeFrequency: 'monthly', priority: 0.6 },
  ...
  { path: '/ocr', changeFrequency: 'monthly', priority: 0.7 },
...
export default function sitemap(): MetadataRoute.Sitemap {
  const corePages: MetadataRoute.Sitemap = CORE_PAGE_DEFINITIONS.map(coreEntry);
