...
const CORE_PAGE_DEFINITIONS: CorePageDefinition[] = [
  ...
  { path: '/sign', changeFrequency: 'monthly', priority: 0.75 },
  { path: '/developers', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/chrome-extension', changeFrequency: 'monthly', priority: 0.55 },
  { path: '/chrome-extension/privacy', changeFrequency: 'yearly', priority: 0.3 },
  { path: '/about', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/developer', changeFrequency: 'monthly', priority: 0.7 },
  { path: '/ajn-studio', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/discover', changeFrequency: 'daily', priority: 0.7 },
  { path: '/blog', changeFrequency: 'weekly', priority: 0.7 },
  { path: '/blog/best-free-pdf-editor', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/blog/browser-native-architecture', changeFrequency: 'monthly', priority: 0.55 },
  { path: '/blog/document-security-aes256', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/blog/how-to-merge-pdfs-online-safely', changeFrequency: 'monthly', priority: 0.65 },
  { path: '/blog/reduce-pdf-size-keep-quality', changeFrequency: 'monthly', priority: 0.65 },
  { path: '/blog/pdf-accessibility-basics', changeFrequency: 'monthly', priority: 0.55 },
  { path: '/faq', changeFrequency: 'monthly', priority: 0.5 },
  { path: '/security', changeFrequency: 'monthly', priority: 0.5 },
  { path: '/limits', changeFrequency: 'monthly', priority: 0.6 },
  { path: '/transparency', changeFrequency: 'monthly', priority: 0.45 },
  ...
  const toolPages: MetadataRoute.Sitemap = BUILD_PUBLIC_TOOLS
    ...
    .map((tool) => {
      ...
      return {
        ...
        priority: tool.badge === 'Popular' ? 0.9 : 0.72,
      };
    });
