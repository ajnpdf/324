...
export default function PdfAccessibilityBasicsGuide() {
  return <GuideArticle
    ...
    sections={[
      { title: 'Start with real text where possible', paragraphs: ['A PDF made only from page images is harder to search, select and navigate with assistive technology.  can add machine-readable text to scans, but recognized text still needs review.', 'When creating a new document, exporting from a structured source is usually better than printing everything to an image.'] },
    ...
    relatedTools={[
      ...
      { href: title: ' guide', description: 'Review AJN PDF  languages and scan-quality guidance.' }]}
  />;
}
