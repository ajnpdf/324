...
export default function ReducePdfSizeGuide() {
  return <GuideArticle
    ...
    relatedTools={[
      ...
      { href: '/scanned-pdf-to-searchable-pdf', title: 'Searchable PDF', description: 'Add OCR text to supported scanned documents.' },
    ]}
  />;
}
