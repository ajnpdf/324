...
export default function PdfVsDocxGuide() {
  return <GuideArticle
    ...
    sections={[
      ...
      { title: 'Use OCR before Word conversion for scans', paragraphs: ['If a PDF page is only an image, there may be no editable text layer to transfer into Word. OCR can identify visible characters first, after which the result can be reviewed and edited.', 'Tables and handwriting still require careful checking even after successful OCR.'] },
    ]}
    checklist={['Use PDF for final presentation', 'Use DOCX for active editing', 'Review conversion layout', 'Use OCR for image-only scans']}
    relatedTools={[
      ...
      { href: '/scanned-pdf-to-word', title: 'Scanned PDF to Word', description: 'Use OCR for scanned pages before Word output.' },
    ]}
  />;
}
