...
export default function FreePdfEditorGuide() {
  return <GuideArticle
    ...
    sections={[
      ...
      { title: 'Look for transparent processing labels', paragraphs: ['A browser tool and a server-assisted conversion have different requirements. The interface should clearly label the processing model instead of making one absolute privacy statement for the entire website.', 'For server-assisted tools, review the file-processing policy, temporary cleanup behaviour, HTTPS deployment and error handling.'] },
