        ...
        <section className="mt-6 grid gap-6 xl:grid-cols-[.85fr_1.15fr]">
          <form onSubmit={submit} className="ajn-theme-surface rounded-[2rem] p-6 md:p-8">
            ...
            <div className="mt-7 space-y-5">
              ...
              <label className="block text-sm font-black text-foreground">Title<Input name="title" minLength={5} maxLength={120} required className="mt-2" placeholder="Example: AJN PDF OCR workflow update" /></label>
              ...
              <label className="block text-sm font-black text-foreground">Tags<Input name="tags" maxLength={240} className="mt-2" placeholder="AJN PDF, OCR, document tools" /></label>
