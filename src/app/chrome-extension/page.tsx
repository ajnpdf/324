...
export const metadata: Metadata = {
  title: 'AJN PDF Chrome Extension — Quick Local Tools & PDF Workflow Search',
  description: 'Use four local image quick actions and search the current AJN PDF workflow catalog from Chrome without page or browsing-history access.',
  alternates: { canonical: '/chrome-extension' },
  openGraph: {
    title: 'AJN PDF Chrome Extension',
    description: 'Local image quick actions plus fast access to the current AJN PDF workflow catalog.',
...
export default function ChromeExtensionPage() {
  const jsonLd = {
    ...
    description: 'Chrome extension with local image quick actions and search across the current AJN PDF workflows.',
  };
    ...
    <div className="ajn-page-shell min-h-screen bg-white">
      ...
      <main className="pt-[64px] md:pt-[72px]">
        <section className="mx-auto max-w-7xl px-4 pb-14 pt-14 text-center md:px-8 md:pb-20 md:pt-24">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-base font-medium leading-8 text-slate-600 md:text-lg">Four useful image actions run directly inside the extension, while fast search puts {BUILD_PUBLIC_TOOLS.length} current AJN PDF workflows one click away.</p>
