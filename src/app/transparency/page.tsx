...
const modes = [
  { icon: Monitor, title: 'On-device workflows', tag: 'In your browser', accent: 'bg-blue-50 text-blue-600 border-blue-100', body: 'Many everyday PDF and image actions work inside the active browser session. The tool page shows practical file limits before you begin.' },
