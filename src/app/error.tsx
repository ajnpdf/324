  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-background px-5 py-20 text-foreground">
      <section className="ajn-theme-surface w-full max-w-xl rounded-[2rem] p-8 text-center md:p-12" role="alert">
        <span className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-red-50 text-red-600 dark:bg-red-500/15 dark:text-red-300"><TriangleAlert className="h-8 w-8" /></span>
        ...
        {isChunkError && <p className="mt-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs font-bold text-amber-900 dark:border-amber-400/20 dark:bg-amber-500/10 dark:text-amber-200">A newer deployment may be available. AJN PDF attempted one safe refresh.</p>}
