      ...
      sections={[
        {
          ...
          paragraphs: [
            ...
            'Advanced conversion, OCR, protection, unlocking and repair workflows may upload the selected file temporarily over HTTPS to complete the requested action. Each request uses an isolated temporary working area that is scheduled for cleanup after the result is returned.',
          ],
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            'After optional consent, AJN PDF may record anonymous page paths, tool-funnel events, aggregate conversion outcomes and Core Web Vitals. Product analytics excludes uploaded contents, filenames, passwords, extracted OCR text and persisted raw IP addresses.',
