    ...
    <LegalPageShell
      ...
      sections={[
        ...
        },
        {
          ...
          paragraphs: [
            'PDF, Office, OCR and image formats can contain features that are not preserved by every conversion. Fonts, forms, links, accessibility tags, charts, animations, tables and layout may change. OCR may contain recognition errors. Repair may not recover severely damaged files.',
