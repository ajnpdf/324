...
const checks = [
  ...
  ['phone cards use compact R6 content', grid.includes('min-h-[82px]') && grid.includes('h-12 w-16') && grid.includes('line-clamp-1')],
...
console.log('AJN PDF R6 mobile-first horizontal-card verification completed successfully.');
