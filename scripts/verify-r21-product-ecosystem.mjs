...
check('Firebase and Windows/Android setup assets exist', ['firebase.json','firestore.rules','firestore.indexes.json','.env.r21.example','scripts/R21_FIREBASE_SETUP.ps1','scripts/R21_CREATE_API_KEY.ps1','scripts/R21_BUILD_ANDROID.ps1','scripts/R21_SETUP_ALL.ps1'].every(exists));
