...
const page=requireText('src/app/page.tsx',["{ id: 'ocr'","{ id: 'edit'","{ id: 'organize'","{ id: 'security'",'<HowItWorks />','<FeatureShowcase />','<TrustSecurity />','<FAQSection />']);
...
requireText('src/i18n/locales/en.json',['Work Smarter with Powerful PDF Tools.','Made Simple by AJN PDF.','100+ tools to convert']);
