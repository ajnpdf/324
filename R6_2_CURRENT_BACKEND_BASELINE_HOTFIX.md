...
6. Untracked runtime artifacts such as `.venv`, OCR language files, SQLite databases, fixtures, acceptance output, and `__pycache__` do not create false failures.
